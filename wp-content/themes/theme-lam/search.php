    ...
    <section class="banner">
        <div class="banner-content">
            <h1 class="banner-title">
                <?php printf(__('Search Results for: %s', 'theme-lam'), get_search_query()); ?>
            </h1>
        </div>
    </section>
                ...
                <div class="content-grid">
                    <div class="latest-news">
                        ...
                        <div id="news-card-box">
                            <?php if (have_posts()) : ?>
                                ...
                                <article class="news-card-box">
                                    ...
                                    <div class="tags d-flex flex-row align-center">
                                        ...
                                        <a href="<?php echo get_category_link($cat->term_id); ?>" class="mini-tag">
                            ...
                            <?php else : ?>
                                <p><?php _e('Sorry, no results were found.', 'theme-lam'); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="events-section">
                        ...
                        <div class="event-card d-flex align-center justify-center flex-column">
                            <div class="event-content">
                                <p class="event-title">
                                    <?php if (get_field('event_title','option')) {
                                    echo get_field('event_title','option');
                                } ?>
                                </p>
                            </div>
                            <div class="event-bottom d-flex justify-around">
                                <p class="event-date">
                                    <?php if (get_field('event_date','option')) {
                                    echo get_field('event_date','option');
                                } ?>
                                </p>
                                <a href="<?php echo esc_url(get_field('event_link','option')); ?>"
                                    class="event-link d-flex align-center">
                                    Zum Event &nbsp; &nbsp;
                            ...
                            <div class="custom-nav is-mobile">
                                <button class="custom-prev prev2">
                                    <svg width="22" height="15" viewBox="0 0 22 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <line x1="21.9492" y1="7.1875" x2="2.23886" y2="7.1875" stroke="white"
                                            stroke-width="2" />
                                        <path d="M7.42578 13.4482L2.23884 7.22392L7.42578 0.999594" stroke="white"
                                            stroke-width="2" />
                                    </svg>
                                </button>
